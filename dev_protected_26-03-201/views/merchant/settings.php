...
<div class="uk-form-row">
  ...
  <p class="uk-text-muted" style="margin-left: 900px;margin-top: -25px;"><?php echo Yii::t("default","Extended for Next Day")?></p>
  ...
  <div class="uk-grid" >
    ...
    <div class="uk-width-1-6" style="width:5%">    
      <?php echo CHtml::checkBox('stores_late_extn[]',
    in_array($key,(array)$stores_late_extn)?true:false
    ,array('value'=>$key,'class'=>"icheck"))?>
     </div>
