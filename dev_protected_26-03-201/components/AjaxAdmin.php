	...
	class AjaxAdmin extends DbExt
	{
	    ...
	    /*	if($enable_deals=="yes")
	    	...
	    	$params=array(			  
			  ...
			  'item_category_id'=>isset($this->data['item_category_id'])?json_encode($this->data['item_category_id']):'',
	    ...
	    {	    	
			...
			Yii::app()->functions->updateOption("stores_late_extn",
	    	isset($this->data['stores_late_extn'])?json_encode($this->data['stores_late_extn']):''
	    	,$merchant_id);
