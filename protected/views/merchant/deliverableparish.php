...
<?php 
      $default_display_minimum_order_req = 'style="display:none;"';
      if($data['merchant_delivery_type']==1)
      {
          $default_display_minimum_order_req = 'style="display:block;"';
      }       
?>

<div class="uk-form-row min_order_req" <?php echo $default_display_minimum_order_req ; ?> >
...
<?php 
      ...
      if($minimum_order_req==2&&$data['merchant_delivery_type']==1)
      {
...
<?php 
      $default_display_delivery_fee = 'style="display:none;"';
      if($minimum_order_req==2&&$data['merchant_delivery_type']==1)
      {
          $default_display_delivery_fee = 'style="display:block;"';
      }
?>

<div class="uk-form-row delivery_fee_row" <?php echo $default_display_delivery_fee; ?> >
...
<tr>
 ...
 <th><?php echo t("Min Amt")?></th>
 <th><?php echo t("Min Sub Total")?></th>
 <th><?php echo t("Free Above")?></th>
...
<?php 	 
      $default_display_parish_free_above = 'style="display:none;"';
      if(isset($available_services[$key]['parish_free_above']))
      {
          $default_display_parish_free_above = 'style="display:block;"';
      }     
 ?>
 <div class="uk-form-row parish_free_above_<?php echo $key; ?>" <?php  echo $default_display_parish_free_above; ?> >  
  <?php echo CHtml::textField('parish_free_above_'.$key,
  isset($available_services[$key]['parish_free_above'])?$available_services[$key]['parish_free_above']:""
  ,array(
  'class'=>'uk-form-width-small numeric_only',
  // 'data-validation'=>"required"
  ))?>
