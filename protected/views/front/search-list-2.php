    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            ...
            <div class="time-tag">
                   <?php $exp = explode(' ',FunctionsV3::getDeliveryEstimation($merchant_id)); 
                        $deliver_time = isset($exp[0])?$exp[0]:'';;
                ...
                <span class="min"><?php echo isset($exp[1])?$exp[1]:''; ?></span>
            </div> 
	        <?php 
                }
            endif;?>   
        ...
        <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6 pad-0">
            <div class="product-desc">
                ...
                <?php if(!isset($_GET['book-a-table'])){  ?>
              <div class="min-order">
                <?php $minimum_order_details = yii::app()->functions->getMinimumOrder($merchant_id); 
                   $minimum_order  = '';                     
                  if($minimum_order_details['deliver_multi_parish']==true)
                  {
                     $minimum_order   = " varies by parish ";
                  }
                  else 
                  {
                       $minimum_order   = FunctionsV3::prettyPrice($minimum_order_details['minimum_order']);
                  }
                  if($minimum_order!=''&&$minimum_order!='-')
                  {
                ?>
                Minimum order : <?php echo $minimum_order ;?>  
                <?php } ?>
            </div>
                <?php } ?>
                <?php } ?>
